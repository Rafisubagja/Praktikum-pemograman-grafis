window.addEventListener('load', () => {
    ...
    function gameInfos() {
        if(!startGame && firstGame) {
            ...
            ctx.fillStyle = '#000';
            ctx.fillText('Use Arrow Right & Left for move !', (canvas.width / 2) + 2, (canvas.height -250) + 2);
            ctx.fillStyle = '#fff';
            ctx.fillText('Use Arrow Right & Left for move !', canvas.width / 2, canvas.height - 250);
            ctx.fillStyle = '#000';
            ctx.fillText('Press Enter or touch the screen to start !', (canvas.width / 2) + 2, (canvas.height -200) + 2);
            ctx.fillStyle = '#fff';
            ctx.fillText('Press Enter or touch the screen to start !', canvas.width / 2, canvas.height - 200);
        } 
        if(score > 0) {
            ctx.font = '30px sans-serif';
            ctx.fillStyle = '#000';
            ctx.fillText(`Score : ${score}`, canvas.width / 2 + 2, 37);
            ctx.fillStyle = '#fff';
        ...
        if(gameOver) {
            ctx.font = '50px sans-serif';
            ctx.fillStyle = '#000';
            ctx.fillText('Game Over, press Enter or touch the screen to restart !', (canvas.width / 2) + 2, (canvas.height - 200) + 2);
            ctx.fillStyle = '#fff';
            ctx.fillText('Game Over, press Enter or touch the screen to restart !', canvas.width / 2, canvas.height - 200);
        }
    };
